...
var $S = {
    ...
    validate : function() {
        ...
        // empty ul
        if (this.$productModulelength < 1) return false;

        // empty li
        if (this.$productListlength < 1) return false;

        // no condition swipe
        if (this.$productListlength <= this.iPageBlock) return false;
    },
    /*
    ...
    generateSingle : function() {
        ...
        // make li > ul > li
        for (var i=0; i<this.$productListlength; i++) { this.makeCircle(i); }
